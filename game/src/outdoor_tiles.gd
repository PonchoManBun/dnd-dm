...
const JSON_PATH = &"res://assets/generated/outdoor_tiles.json"
const TEXTURE = preload("res://assets/generated/outdoor_tiles.png")
...
func get_coords(p_name: StringName) -> Vector2i:
	...
	if ret == Utils.INVALID_POS:
		Log.e("Outdoor tile not found: %s" % p_name)
