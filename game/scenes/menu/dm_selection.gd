...
const BG_COLOR := Color(0.06, 0.04, 0.03, 1.0)
const PANEL_COLOR := Color(0.12, 0.09, 0.07, 0.95)
...
const TEXT_COLOR := Color(0.93, 0.88, 0.78, 1.0)
const DIM_TEXT_COLOR := Color(0.60, 0.55, 0.45, 1.0)
const TITLE_COLOR := Color(0.95, 0.85, 0.60, 1.0)
